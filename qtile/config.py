    ...
    Screen(
        top=bar.Bar(
            [
                ...
                widget.TextBox(text="", font="fontawesome6", fontsize=24, padding=5, foreground="#e0af68"),
                ...
                widget.TextBox(text="", font="fontawesome6", fontsize=44, padding=-5, foreground="#1e1e2e"),
                widget.CheckUpdates(distro="Arch", execute="alacritty -e sudo pacman -Syu", display_format="  {updates}", foreground="#e0af68", background="#1e1e2e"),
                widget.TextBox(text="", font="fontawesome6", fontsize=44, padding=-5, foreground="#11111b", background="#1e1e2e"),
                widget.Battery(background="#11111b", foreground="#89b4fa", battery="BAT1", format="   {percent:2.0%}", font="fontawesome6", fontsize=15, padding=5, mouse_callbacks={'Button1': lambda: qtile.cmd_spawn('alacritty -e sudo powertop')}),
                widget.TextBox(text="", font="fontawesome6", fontsize=44, padding=-5, foreground="#1e1e2e", background="#11111b"),
                widget.Memory(background="#1e1e2e", foreground="#a6e3a1", format=' {MemUsed: .0f}{mm}/{MemTotal: .0f}{mm}', mouse_callbacks = {'Button1': lambda: qtile.cmd_spawn('alacritty -e htop')}, fontsize=14, padding=4),
                widget.TextBox(text="", font="fontawesome6", fontsize=44, padding=-5, foreground="#11111b", background="#1e1e2e"),
                ...
                widget.TextBox(text="", font="fontawesome6", fontsize=44, padding=-5, foreground="#1e1e2e", background="#11111b"),
                widget.Clock(background="#1e1e2e", format=" %I:%M %p", foreground="#94e2d5", font="fontawesome6", mouse_callbacks={'Button1': lambda: qtile.cmd_spawn('alacritty -e calcurse')}, fontsize=15, padding=5),
                widget.TextBox(text="", font="fontawesome6", fontsize=44, padding=-5, foreground="#11111b", background="#1e1e2e"),
